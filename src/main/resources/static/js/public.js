        ...
        showFormPage: function (p_uri, p_title, p_options) {
            ...
            if (window.pbMyModel) {
                ...
                let myModel = Vue.extend({
                    template: `
                        <Modal v-model="formPageModel" :width="formPageWidth" :styles="{top: '20px'}" :mask-closable="false">
                            ...
                            <iframe id="ifrFormPage" :src="formPageURL" frameborder="0"
                                ...
                                <div slot="footer" v-show="formPageFooter">
                                    <i-button type="text" @click="cancelFormPage">取消</i-button>
                                    <i-button type="primary" :loading="formPageSaving" @click="saveFormPage"
